...
from extraction import extract_key_points, extract_action_items
...
def main():
    ...
    4. Summarizes the transcription using a local Hugging Face Transformers model.
    5. Saves the transcription, key points, and action items to separate files.
    6. Creates a summary video using the HeyGen API.
    ...
    try:
        ...
        # Summarize transcription using local Hugging Face Transformers
        print("\n\n==== (2) Summarizing meeting...")
        try:
            # Generate a summary of the transcription
            summary = summarize_text(transcription)
            
            # Extract key points and action items from the summary
            ...
            save_to_file("\n".join(key_points), key_points_file)
            save_to_file("\n".join(action_items), action_items_file)
        ...
        try:
            ...
            bullet_point_list1 = key_points  # already a list from extract_key_points
            ...
            bullet_point_list2 = action_items  # already a list from extract_action_items
            speaker_script_paragraph_list2 = f"Here are the top action items from the meeting:\n{summary}"[:800]
        ...
        try:
            ...
            # Retrieve related videos using a semantic query
